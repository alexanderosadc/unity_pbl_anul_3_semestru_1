...
public class UploadGoogleCloudStorage
{
	...
	/// </summary>
	private const string keyFile = "pblanul3semestrul1-cf1afb77eef1.p12";

	/// <summary>
	/// P12 key password.
	/// </summary>
	private const string keyPassword = "notasecret";

	/// <summary>
	/// Service Accounts email address.
	/// </summary>
	private const string email = @"alexanderosadc@gmail.com";

	/// <summary>
	/// Budget name to be uploaded.
	/// Budget needs to be created in advance.
	/// </summary>
	private const string badgetName = @"cube";

	private const string baseDir = "AssetBundles";
	private static readonly BuildTarget[] buildTargets =
		new BuildTarget[] { BuildTarget.WebGL };
	...
	private static void UpdateFileAcl (string filename, string token)
	{
		...
		var url = string.Format (baseUrl, badgetName, WWW.EscapeURL (filename));
